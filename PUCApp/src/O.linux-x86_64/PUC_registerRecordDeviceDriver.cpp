...
/* Generated from ../O.Common/PUC.dbd */
...
epicsShareExtern void (*pvar_func_devFrontendConfigure_RegisterCommands)(void);
...
epicsShareExtern void (*pvar_func_devPCIeFPGARegister)(void);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"PUC_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    PUC_registerRecordDeviceDriver(*iocshPpdbbase);
}
